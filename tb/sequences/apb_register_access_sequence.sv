...
class apb_register_access_sequence extends apb_sequence;
    ...
    task body();
        ...
        // ============================================================
        // Toggle coverage stimulus
        // ============================================================
        
        // ------------------------------------------------------------
        // CTRL:
        // drive useful control bits high, then low
        // ------------------------------------------------------------
        apb_write(
            8'h00,
            32'h0000_0007,   // enable + tx_enable + rx_enable
            4'b0001,
            3'b000
        );
        ...
        // ------------------------------------------------------------
        // INT:
        // enable both IRQ bits, then clear them
        // ------------------------------------------------------------
        apb_write(
            8'h18,
            32'h0000_0003,
