`ifndef UART_RX_GAP0_TEST_SV
`define UART_RX_GAP0_TEST_SV

class uart_rx_gap0_test extends uart_rx_test;

    `uvm_component_utils(uart_rx_gap0_test)

    function new(
        string name = "uart_rx_gap0_test",
